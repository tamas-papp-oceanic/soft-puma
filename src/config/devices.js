const devices = {
  '3125':      { id: 0x0B, conf: true,  fluid: true,  prog: true,  address: null,       test: false, group: 'adaptors', title: 'Tank Sender Adaptor' },
  '3130':      { id: 0x17, conf: false, fluid: false, prog: true,  address: null,       test: false, group: 'adaptors', title: 'Fuel Sender to Resistive Output Adaptor' },
  '3155-ATC':  { id: 0x10, conf: false, fluid: false, prog: false, address: null,       test: false, group: 'adaptors', title: '3155_ATC Tank Level Modbus Master (ATC)' },
  '3155-MCS':  { id: 0x11, conf: false, fluid: false, prog: false, address: null,       test: false, group: 'adaptors', title: 'MCS HVAC MODBUS Master (MCS)' },
  '3155-SCH':  { id: 0x12, conf: false, fluid: false, prog: false, address: null,       test: false, group: 'adaptors', title: 'SCH AC MODBUS Master (Schneider)' },
  '3165':      { id: 0x19, conf: false, fluid: false, prog: true,  address: null,       test: false, group: 'adaptors', title: 'Rudder Angle Adapter' },
  '3185':      { id: 0x0C, conf: false, fluid: false, prog: false, address: null,       test: false, group: 'adaptors', title: 'J1939 to NMEA2000 Adaptor' },
  '3271':      { id: 0x1C, conf: true,  fluid: true,  prog: true,  address: null,       test: false, group: 'sensors',  title: 'Volumetric Fuel Sender' },
  '3271-SAM2': { id: 0x1C, conf: false, fluid: false, prog: true,  address: null,       test: false, group: 'modules',  title: 'SAM2 Sender Averaging Module' },
  '3281':      { id: 0x03, conf: true,  fluid: true,  prog: true,  address: null,       test: false, group: 'sensors',  title: 'Water Sender' },
  ...
  '4510':      { id: 0x04, conf: true,  fluid: false, prog: false, address: null,       test: false, group: 'sensors',  title: 'EGT Sender' },
  '4521':      { id: 0x06, conf: true,  fluid: false, prog: false, address: null,       test: false, group: 'modules',  title: '4 Channel Temperature Module' },
  ...
  '5185':      { id: 0x00, conf: false, fluid: false, prog: false, address: null,       test: true,  group: 'displays', title: 'Poseidon 7' },
  '5185-H':    { id: 0x00, conf: false, fluid: false, prog: false, address: null,       test: true,  group: 'displays', title: 'Poseidon 7 (Honda)' },
};
