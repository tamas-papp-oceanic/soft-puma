const devices = {
  ...
  '3155-ATC':  { id: 0x10, conf: false, fluid: false, prog: false, test: false, group: 'adaptors', title: '3155_ATC Tank Level Modbus Master (ATC)' },
  '3155-MCS':  { id: 0x11, conf: false, fluid: false, prog: false, test: false, group: 'adaptors', title: 'MCS HVAC MODBUS Master (MCS)' },
  '3155-SCH':  { id: 0x12, conf: false, fluid: false, prog: false, test: false, group: 'adaptors', title: 'SCH AC MODBUS Master (Schneider)' },
  '3165':      { id: 0x19, conf: false, fluid: false, prog: true,  test: false, group: 'adaptors', title: 'Rudder Angle Adapter' },
  ...
  '4601':      { id: 0x09, conf: true,  fluid: false, prog: false, test: false, group: 'modules',  title: '4-20mA Fluid Pressure Module' },
  ...
  '5720':      { id: 0x16, conf: true,  fluid: false, prog: true,  test: false, group: 'adaptors', title: 'Fluid Flow Adapter', address: 0x08004000 },
